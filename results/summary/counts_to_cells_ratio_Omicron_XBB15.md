...
```python
variant_counts = pd.read_csv(config['variant_counts_Omicron_XBB15'])
```
...
```
    ...
    Primary target is Omicron_XBB15
...
print(f"First few lines of the data frame, writing entirety to {config['counts_to_cells_csv_Omicron_XBB15']}:")
display(HTML(counts_cells.head().to_html(index=False, float_format='{:.2g}'.format)))
counts_cells.to_csv(config['counts_to_cells_csv_Omicron_XBB15'], index=False, float_format='%.3g')
```

    First few lines of the data frame, writing entirety to results/counts/Omicron_XBB15/counts_to_cells_csv.csv:
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <td>exptREF2-none-0-ref, lib59</td>
      <td>230622</td>
      <td>exptREF2</td>
      <td>none</td>
      <td>0</td>
    ...
    <tr>
      <td>exptREF2-none-0-ref, lib60</td>
      <td>230622</td>
      <td>exptREF2</td>
      <td>none</td>
      <td>0</td>
    ...
    <tr>
      <td>expt6-S2V29_v37_2-42-abneg, lib59</td>
      <td>230622</td>
      <td>expt6</td>
      <td>S2V29_v37_2</td>
      <td>42</td>
    ...
    <tr>
      <td>expt6-S2V29_v37_2-42-abneg, lib60</td>
      <td>230622</td>
      <td>expt6</td>
      <td>S2V29_v37_2</td>
      <td>42</td>
    ...
    <tr>
      <td>exptREF-none-0-ref, lib59</td>
      <td>230615</td>
      <td>exptREF</td>
      <td>none</td>
      <td>0</td>
...
```
    ...
    /scratch/local/u6042467/6530457/ipykernel_4191227/1580948032.py:14: SettingWithCopyWarning: 
...
![png](counts_to_cells_ratio_Omicron_XBB15_files/counts_to_cells_ratio_Omicron_XBB15_13_1.png)
...
![png](counts_to_cells_ratio_Omicron_XBB15_files/counts_to_cells_ratio_Omicron_XBB15_13_3.png)
...
![png](counts_to_cells_ratio_Omicron_XBB15_files/counts_to_cells_ratio_Omicron_XBB15_13_5.png)
