...
```python
variant_counts = pd.read_csv(config['variant_counts_Omicron_BQ11'])
```
...
```
    ...
    Primary target is Omicron_BQ11
...
print(f"First few lines of the data frame, writing entirety to {config['counts_to_cells_csv_Omicron_BQ11']}:")
display(HTML(counts_cells.head().to_html(index=False, float_format='{:.2g}'.format)))
counts_cells.to_csv(config['counts_to_cells_csv_Omicron_BQ11'], index=False, float_format='%.3g')
```

    First few lines of the data frame, writing entirety to results/counts/Omicron_BQ11/counts_to_cells_csv.csv:
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <td>exptREF2-none-0-ref, lib57</td>
      <td>230622</td>
      <td>exptREF2</td>
      <td>none</td>
      <td>0</td>
    ...
    <tr>
      <td>exptREF2-none-0-ref, lib58</td>
      <td>230622</td>
      <td>exptREF2</td>
      <td>none</td>
      <td>0</td>
    ...
    <tr>
      <td>expt1-S2V29_v37_2-52-abneg, lib57</td>
      <td>230622</td>
      <td>expt1</td>
      <td>S2V29_v37_2</td>
      <td>52</td>
    ...
    <tr>
      <td>expt1-S2V29_v37_2-52-abneg, lib58</td>
      <td>230622</td>
      <td>expt1</td>
      <td>S2V29_v37_2</td>
      <td>52</td>
    ...
    <tr>
      <td>exptREF-none-0-ref, lib57</td>
      <td>230615</td>
      <td>exptREF</td>
      <td>none</td>
      <td>0</td>
...
```
    ...
    /scratch/local/u6042467/8550300/ipykernel_2202838/1580948032.py:14: SettingWithCopyWarning: 
...
![png](counts_to_cells_ratio_Omicron_BQ11_files/counts_to_cells_ratio_Omicron_BQ11_13_1.png)
...
![png](counts_to_cells_ratio_Omicron_BQ11_files/counts_to_cells_ratio_Omicron_BQ11_13_3.png)
...
![png](counts_to_cells_ratio_Omicron_BQ11_files/counts_to_cells_ratio_Omicron_BQ11_13_5.png)
