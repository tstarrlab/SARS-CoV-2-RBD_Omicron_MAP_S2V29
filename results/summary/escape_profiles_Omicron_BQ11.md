# Plot escape profiles for Omicron BQ11 background MAP
...
```
    ...
    /scratch/local/u6042467/137454/ipykernel_2810378/4149783140.py:55: MatplotlibDeprecationWarning: The get_cmap function was deprecated in Matplotlib 3.7 and will be removed two minor releases later. Use ``matplotlib.colormaps[name]`` or ``matplotlib.colormaps.get_cmap(obj)`` instead.
...
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_18_4.png)
    ...
    /scratch/local/u6042467/137454/ipykernel_2810378/4149783140.py:74: MatplotlibDeprecationWarning: The get_cmap function was deprecated in Matplotlib 3.7 and will be removed two minor releases later. Use ``matplotlib.colormaps[name]`` or ``matplotlib.colormaps.get_cmap(obj)`` instead.
...
```
    ...
    Reading escape-profile configuration from data/escape_profiles_config_Omicron_BQ11.yaml
...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/Omicron_BQ11/S2V29_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_stackedlogo.png.



    
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_3.png)
    


    
    Plotted profile 2 to:
     results/escape_profiles/Omicron_BQ11/S2V29_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_color_by_bind_stackedlogo.png.



    
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_5.png)
    


    
    Plotted profile 3 to:
     results/escape_profiles/Omicron_BQ11/S2V29_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_7.png)
    


    
    Plotted profile 4 to:
     results/escape_profiles/Omicron_BQ11/S2V29_wide_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_wide_stackedlogo.png.
...
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_9.png)
    ...
    Plotted profile 5 to:
     results/escape_profiles/Omicron_BQ11/S2V29_wide_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_wide_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_11.png)
    ...
    Plotted profile 6 to:
     results/escape_profiles/Omicron_BQ11/S2V29_wide_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_wide_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_13.png)
    


    
    Plotted profile 7 to:
     results/escape_profiles/Omicron_BQ11/S2V29_structural_epitope_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_structural_epitope_stackedlogo.png.
...
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_15.png)
    ...
    Plotted profile 8 to:
     results/escape_profiles/Omicron_BQ11/S2V29_structural_epitope_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_structural_epitope_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_17.png)
    ...
    Plotted profile 9 to:
     results/escape_profiles/Omicron_BQ11/S2V29_structural_epitope_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_structural_epitope_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_19.png)
    ...
    Plotted profile 10 to:
     results/escape_profiles/Omicron_BQ11/S2V29_wide_single_nt_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_wide_single_nt_stackedlogo.png.



    
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_21.png)
    


    
    Plotted profile 11 to:
     results/escape_profiles/Omicron_BQ11/S2V29_wide_single_nt_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_wide_single_nt_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_23.png)
    ...
    Plotted profile 12 to:
     results/escape_profiles/Omicron_BQ11/S2V29_wide_single_nt_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BQ11/S2V29_wide_single_nt_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_Omicron_BQ11_files/escape_profiles_Omicron_BQ11_26_39.png)
