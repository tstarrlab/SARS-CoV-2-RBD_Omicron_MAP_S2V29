    ...
    run:
        ...
        with open(output.summary, 'w') as f:
            ...
            2. Count variants and then aggregate counts for
               ...
               [Omicron_BQ11]({path(input.aggregate_variant_counts_Omicron_BQ11)}), and
               ...
               [Omicron_BQ11]({path(input.variant_counts_Omicron_BQ11)}), and
               [Omicron_BA2]({path(input.variant_counts_Omicron_BA2)}).
            ...
            3. Analyze sequencing counts to cells ratio for [Wuhan_Hu_1]({path(input.counts_to_cells_ratio_Wuhan_Hu_1)}), 
               ...
               [Omicron_BQ11]({path(input.counts_to_cells_ratio_Omicron_BQ11)}) and 
               ...
               [Omicron_BQ11]({path(input.counts_to_cells_csv_Omicron_BQ11)}) and 
               [Omicron_XBB15]({path(input.counts_to_cells_csv_Omicron_XBB15)}) with the
            ...
            4. Calculate escape scores from variant counts for [Wuhan_Hu_1]({path(input.counts_to_scores_Wuhan_Hu_1)}), 
               ...
               [Omicron_BQ11]({path(input.counts_to_scores_Omicron_BQ11)}) and 
            ...
            5. Call sites of strong escape for [Wuhan_Hu_1]({path(input.call_strong_escape_sites_Wuhan_Hu_1)}), 
               ...
               [Omicron_BQ11]({path(input.call_strong_escape_sites_Omicron_BQ11)}) and 
            ...
            6. Plot escape profiles for [Wuhan_Hu_1]({path(input.escape_profiles_Wuhan_Hu_1)}), 
               ...
               [Omicron_BQ11]({path(input.escape_profiles_Omicron_BQ11)}) and 
            ...
            7. Map escape profiles to ``*.pdb`` files using notebooks here for 
               ...
               [Omicron_BQ11]({path(input.output_pdbs_Omicron_BQ11)}) and 
           ...
           9. Make supplementary data files for [Wuhan_Hu_1]({path(input.make_supp_data_Wuhan_Hu_1)}), 
               ...
               [Omicron_BQ11]({path(input.make_supp_data_Omicron_BQ11)}) and 
               ...
               [Omicron_BQ11]({path(config['supp_data_dir_Omicron_BQ11'])}) and 
               [Omicron_XBB15]({path(config['supp_data_dir_Omicron_XBB15'])}). These include
