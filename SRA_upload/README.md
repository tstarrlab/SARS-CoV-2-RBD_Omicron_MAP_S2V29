...
For the sample name, provide a short name that describes the sample, such as `Vir_S2V29_MAP_barcodes`.
...
Finally, add a sample title, such as "Illumina barcode sequencing from mutational antigenic profiling of S2V29 and related mAbs"
Then hit `Continue`, make sure everything looks correct, then hit `Submit`.

After a brief bit of processing, the *BioSample* submission should show up, along with a sample accession : *SAMN41694243*
